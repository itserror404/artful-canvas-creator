  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute top-1/4 -left-24 h-72 w-72 rounded-full bg-artify-accent/10 blur-3xl"></div>
        ...
        <div className="absolute top-1/2 left-1/5 floating-card h-14 w-14 bg-artify-accent/10 rounded-lg shadow-lg animate-float-alt">
