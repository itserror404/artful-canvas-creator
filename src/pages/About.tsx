        ...
        <div className="max-w-3xl mx-auto bg-artify-primary p-8 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {[
              ...
              <div key={index} className="bg-artify-background p-5 rounded-lg border border-gray-800">
                <h3 className="text-xl font-semibold mb-1">{member.name}</h3>
                <p className="text-artify-secondary mb-2">{member.role}</p>
          ...
          <div className="mt-8 p-4 bg-artify-secondary/10 rounded-lg border border-artify-secondary/30">
            <p className="text-center text-lg">
              Have questions or suggestions? <a href="#" className="text-artify-secondary underline">Contact us</a>
            </p>
          </div>
        </div>
      </div>
